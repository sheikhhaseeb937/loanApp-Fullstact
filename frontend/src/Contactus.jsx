...
const handlesubmit = async (e) => {
  ...
  try {
    const response = await axios.post(`${import.meta.env.VITE_BASE_URL || "http://localhost:8080"}/contactus`, contactData);
console.log(response)
    ...
    toast.error("Contact Form Not Submitted. Please try again.", {
      position: "top-right",
      autoClose: 2000,
      theme: "dark",
      transition: Bounce,
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 mt-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Contact <span className='text-green-600'>QuickFunds</span></h1>
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Have questions about our loan services? Get in touch with our team today.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+92 3150006458</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@quickfunds.com</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">5/B Financial Street</p>
                  <p className="text-gray-600">karachi, Pakistan - 4001</p>
                </div>
              </div>
            </div>
